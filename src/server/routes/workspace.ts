...
import { autoOpenOrInitDefaultWorkspace, initWorkspace, openWorkspace, workspaceStatus } from "../services/workspace-service.js"

export function registerWorkspaceRoutes(router: Router): void {
  router.get("/api/workspace", () => autoOpenOrInitDefaultWorkspace())
  router.get("/api/workspace/status", () => workspaceStatus())
